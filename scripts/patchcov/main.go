...
// zero execution count. Test files and the scripts/ tooling tree are excluded.
// Lines that do not appear in the profile at all are treated as non-coverable
// and ignored, matching codecov's "coverable lines" semantics.
//
